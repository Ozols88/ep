    ...
    if ($account->manager == 1) {
        ...
        elseif ($_SESSION['new-task']['stage'] == '1c') { ?>
            ...
            <div class="table medium">
                <div class="row">
                    <input form="objective" name="objective" id="objective" class="field admin" placeholder="Enter Task Objective Here" maxlength="100">
                </div>
            </div> <?php
        }
        elseif ($_SESSION['new-task']['stage'] == '2c') { ?>
            ...
            <div class="table medium">
                <div class="row">
                    <textarea form="description" name="description" id="description" class="field admin" placeholder="Enter Task Description Here" maxlength="500"></textarea>
                </div>
            </div> <?php
        }
        elseif ($_SESSION['new-task']['stage'] == '3c') { ?>
