...
if (isset($_SESSION['account'])) {
    ...
    if ($account->manager == 1) {
        ...
        if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "SAVE") {
                    ...
                    // From new-assignment
                        ...
                        if ($projectStatus == 7 || $projectStatus == 8) {
                            ...
                            Project::update('project', $_SESSION['new-assignment']['fields']['projectid'], ["statusid" => $statusID], null);
                        }
            ...
            elseif ($_SESSION['new-assignment']['divisionid'] != "1") {
        ...
        if ($_SESSION['new-assignment']['stage'] == '1') { ?>
            ...
            $projects6 = Project::selectProjectListByStatus(6);
            $projects4 = Project::selectProjectListByStatus(4);
            $projects = array_merge((array)$projects6, (array)$projects4);
        ...
        elseif ($_SESSION['new-assignment']['stage'] == '3c') { ?>
            ...
            <div class="table small">
                <div class="row">
                    <input form="title" name="title" id="title" class="field admin" placeholder="Enter Assignment Name Here" maxlength="50">
                </div>
            </div> <?php
        }
        elseif ($_SESSION['new-assignment']['stage'] == '4c') { ?>
            ...
            <div class="table medium">
                <div class="row">
                    <input form="objective" name="objective" id="objective" class="field admin" placeholder="Enter Assignment Objective Here" maxlength="100">
                </div>
            </div> <?php
        }
        elseif ($_SESSION['new-assignment']['stage'] == '5c') { ?>
