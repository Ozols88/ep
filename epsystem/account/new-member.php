...
if (isset($_SESSION['account'])) {
        ...
        elseif ($_SESSION['new-member']['stage'] == '3') {
            ...
            if (isset($_POST['division'])) {
                ...
                if ($_POST['division'] == null)
                    $_SESSION['new-member']['divisions'][$_SESSION['new-member']['num']++] = [
                        'id' => null,
                        'floorid' => $_SESSION['new-member']['add-division-page']['floor'],
                        'groupid' => "",
                        'title' => "Custom",
                        'description' => ""
                    ];
    ...
    elseif ($_SESSION['new-member']['stage'] == '3') {
        if (!isset($_SESSION['new-member']['add-division-page'])) { ?>
                ...
                if (is_array($_SESSION['new-member']['divisions']) && count($_SESSION['new-member']['divisions']) > 0) {
                    foreach ($_SESSION['new-member']['divisions'] as $num => $division) { ?>
                        <form method="post" class="row">
                            ...
                            <div class="cell" style="width: 35%"><input type="submit" name="submit" value="<?php echo $division['floorid'] ?>" class="content"></div>
            ...
            if (!isset($_SESSION['new-member']['add-division-page']['select-division'])) { ?>
                ...
                <div class="head-up-display-bar">
                    <span>+ New Project: Select Division</span>
                </div>
                <div class="navbar level-1 unselected">
    ...
    elseif ($_SESSION['new-member']['stage'] == '4') { ?>
        ...
        <div class="table small">
            <div class="row">
                <input form="username" name="username" id="username" class="field admin" placeholder="Enter Member Name Here">
            </div>
        </div> <?php
    }
